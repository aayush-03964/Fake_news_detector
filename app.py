...
stop_words_lookup = set(stopwords.words('english'))

# 1. The Exact Same Cleaning Function from Step 2
...
# 2. Load the Saved Pickle Artifacts
@st.cache_resource
def load_assets():
...
try:
    ...
    st.error("Error: Serialization files ('model.pkl' or 'vectorizer.pkl') not found.")
